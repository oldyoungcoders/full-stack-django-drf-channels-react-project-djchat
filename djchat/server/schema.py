...
server_list_docs = extend_schema(
    ...
    parameters=[
        ...
        OpenApiParameter(
            ...
            location=OpenApiParameter.QUERY,
            description="Limit the number of servers retrieve",
        ),
        OpenApiParameter(
            name="by_user",
            type=OpenApiTypes.BOOL,
            location=OpenApiParameter.QUERY,
            description="Filter servers by the authenticated user (True/False)",
        ),
        OpenApiParameter(
        ...
        OpenApiParameter(
            ...
            type=OpenApiTypes.STR,
            location=OpenApiParameter.QUERY,
            description="Include servers by server id",
        ),
    ],
)
